...
export const dict: Dict = {
  ...
  settings_about_text: { en: "NomaDomo matches student guides and locals with travelers across Japan. Still in MVP — please send bugs and feedback.", ja: "NomaDomo は日本各地の学生ガイド・地元民と旅行者をマッチングするアプリよ。MVP 段階だから不具合あったら通報してね。" },
