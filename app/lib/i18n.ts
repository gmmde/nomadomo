...
export const dict: Dict = {
  ...
  tut_home_body_local: { en: "This is where the list of travelers visiting Kyoto shows up. Tap anyone you're interested in helping out!", ja: "ここに京都に来てる旅行者が一覧表示されるわよ。気になる人をタップしてプロフィールを見てみて！" },
